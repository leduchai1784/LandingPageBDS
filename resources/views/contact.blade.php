...
@section('title', 'Liên hệ với chúng tôi - LDH Homes')
								...
								<div class="row">
									...
									<div class="col-md-12 text-center">
										<button type="submit" value="Send message" name="submit" id="submitButton"
											class="btn btn-contact-bg" title="Gửi đi Nội dung tin nhắn!">Gửi tin nhắn</button>
									</div>
								</div>
							</form>
						</div>
				...
				<div class="col-lg-4 col-sm-4 col-xs-12">
					<div class="single_contact_two">
						<div class="single_address">
							<i class="fa fa-rocket color-one"></i>
							<h4>Địa chỉ của chúng tôi</h4>
							<p>3481 Melrose Place, Beverly Hills, <br>CA 90210, Hoa Kỳ</p>
						</div>
						<div class="single_address">
