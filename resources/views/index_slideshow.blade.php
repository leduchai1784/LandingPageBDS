...
@section('title', 'Slide giới thiệu - LDH Homes')
...
<!-- START HOME -->
	<section id="home" class="home-area">
		<div id="home-slider" class="flexslider text-center loading">
			<ul class="slides">
				<li style="background: url('{{ asset('assets/img/bg/slide1.jpg') }}') no-repeat center center;">
					<div class="hero-text">
				...
				<li style="background: url('{{ asset('assets/img/bg/slide2.jpg') }}') no-repeat center center;">
					<div class="hero-text">
						<h2>Giao dịch bất động sản tốt nhất</h2>
						<p>Tìm kiếm và sở hữu những bất động sản mơ ước với mức giá tốt nhất cùng dịch vụ chuyên nghiệp hàng đầu từ chúng tôi.</p>
						<div class="home_btn">
				...
				<li style="background: url('{{ asset('assets/img/bg/slide3.jpg') }}') no-repeat center center;">
					<div class="hero-text">
						<h2>Giao dịch bất động sản tốt nhất</h2>
						<p>Tìm kiếm và sở hữu những bất động sản mơ ước với mức giá tốt nhất cùng dịch vụ chuyên nghiệp hàng đầu từ chúng tôi.</p>
						<div class="home_btn">
