...
@section('title', 'Hiệu ứng Parallax - LDH Homes')

@section('content')
<!-- START HOME -->
	<section data-stellar-background-ratio="0.3" id="home" class="home_bg"
		style="background-image: url('{{ asset('assets/img/bg/parallax-bg.jpg') }}');  background-size:cover; background-position: center center;">
		<div class="container">
			<div class="row">
