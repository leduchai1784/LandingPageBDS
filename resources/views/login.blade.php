...
@section('title', 'Đăng nhập tài khoản - LDH Homes')
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offset-lg-3 col-sm-12 col-xs-12">
					<div class="login">
						<h4 class="login_register_title">Đã là thành viên? Đăng nhập tại đây</h4>
						...
						<div class="form-group col-md-12 mbnone">
							<button class="btn btn-contact-bg" type="submit" name="submit">Đăng nhập</button>
						</div>
					</div>
				</div><!--- END COL -->
			</div><!--- END ROW -->
